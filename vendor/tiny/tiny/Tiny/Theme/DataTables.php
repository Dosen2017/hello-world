...
class DataTables implements tiny\ThemeBuilder
{
    ...
    private function _show()
    {
        ...
        echo tiny\View::script('js/bootstrap/plugin/daterangepicker/moment.js');
        echo tiny\View::script('js/bootstrap/plugin/daterangepicker/daterangepicker.js');
        echo tiny\View::style('js/bootstrap/plugin/daterangepicker/daterangepicker-bs3.css');
        echo tiny\View::script('js/bootstrap/plugin/multiselect/bootstrap-multiselect.js');
        echo tiny\View::style('js/bootstrap/plugin/multiselect/bootstrap-multiselect.css');
